...
class CGAN(object):
    ...
    def __init__(self, sess, epoch, batch_size, z_dim, dataset_name,
        ...
        print("X_img.shape: {0}".format(X_img.shape))
        print("y_conditional.shape: {0}".format(y_conditional.shape))
        print("y_for_visualization_samples.shape: {0}".format(y_for_visualization_samples.shape))
